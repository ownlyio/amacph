        ...
        <section id="amac-banner" className="h-screen background-image-cover position-relative py-5" style={{"backgroundImage": `url(${banner})`}}>
            <div className="container h-100 pt-5">
                <div className="d-flex justify-content-center align-items-center h-100 flex-column">
                    ...
                    <p className="font-size-100 font-size-sm-120 font-size-md-150 font-size-lg-180 neo-bold text-center text-white mb-5 banner-sub">October 8-9, 2022 | Ayala Malls Legazpi</p>
