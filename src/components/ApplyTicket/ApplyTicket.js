            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-12 col-md-5 mb-5 mb-md-0">
                        <p className="text-center text-md-start font-size-130 font-size-sm-160 font-size-md-200 font-size-lg-280 text-white arvo-bold ticket-title">BUY TICKETS</p>
                        ...
                        <div className="row justify-content-center align-items-center mb-4 mb-lg-0">
                            <div className="col-12 col-md-5">
                                <div className="ticket-img-wrap">
                                    ...
                                    <p className="text-center font-size-100 font-size-md-110 font-size-lg-130 text-white arvo-italic ticket-det mb-3 mb-lg-5">AMAC2022 X Lei Melendres Shirt</p>
                                </div>
                            </div>
                            ...
                            <div className="col-12 col-md-5">
                                <div className="ticket-img-wrap">
                                    ...
                                    <p className="text-center font-size-100 font-size-md-110 font-size-lg-130 text-white arvo-italic ticket-det mb-3 mb-lg-5">3D Mustachio Rascals</p>
                                </div>
                            </div>
                        </div>
